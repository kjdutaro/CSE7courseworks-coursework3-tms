    ...
    <div class="container mt-5">
        <form method="post" class="mt-5">
            ...
            <div class="input-group mb-3">
                ...
                <button type="submit" class="btn btn-primary" name="addTask" type="button" id="button-addon2">Add
                    Task</button>
            </div>
        </form>
        ...
        <form method="post" class="mt-3">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" id="userName" name="userName" placeholder="User"
                    aria-label="User" aria-describedby="button-addon2">
                <button type="submit" class="btn btn-primary" name="addUser" type="button" id="button-addon2">Add
                    User</button>
            </div>
        </form>
            ...
            <?php foreach ($tasks as $task): ?>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <div class="col">
                        ...
                        <p>User:
                            <?php echo $task['userId']; ?>
                        </p>
                    </div>
                    <form method="post">
                        <input type="hidden" name="taskId"
                            value="<?php echo isset($task['taskId']) ? $task['taskId'] : ''; ?>">
                        <button type="submit"
                            class="btn <?php echo isset($task['is_done']) && $task['is_done'] ? 'btn-success' : 'btn-danger'; ?> btn-sm"
                            name="markDone">
                            <?php echo isset($task['is_done']) && $task['is_done'] ? 'Done' : 'Pending'; ?>
                        </button>
